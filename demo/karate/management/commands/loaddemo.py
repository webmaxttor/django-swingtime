...
def create_sample_data():
    ...
    evt = swingtime.create_event(
        ...
        start_time=timezone.make_aware(datetime.combine(now.date(), time(16))),
        end_time=timezone.make_aware(datetime.combine(now.date(), time(18))),
    ...
    evt = swingtime.create_event(
        ...
        start_time=timezone.make_aware(datetime.combine(now.date(), time(19))),
        count=30,
    ...
    evt = swingtime.create_event(
        ...
        start_time=timezone.make_aware(datetime.combine(now.date(), time(18))),
    ...
    evt = swingtime.create_event(
        ...
        start_time=timezone.make_aware(datetime.combine(now.date(), time(18, 30))),
        end_time=timezone.make_aware(datetime.combine(now.date(), time(20, 30))),
        count=6,
        freq=rrule.MONTHLY,
    ...
    evt = swingtime.create_event(
        ...
        start_time=timezone.make_aware(datetime.combine(now.date(), time(12))),
        end_time=timezone.make_aware(datetime.combine(now.date(), time(16))),
        interval=2,
        count=6,
        byweekday=(rrule.SU)
    )
